...
//    return AlarmService.setBackgroundFlutterView(nativeView);
  ...
  public static class NewPlugin implements io.flutter.embedding.engine.plugins.FlutterPlugin {
    AlarmManagerPluginMethodCallHandler methodCallHandler;
    MethodChannel alarmManagerPluginChannel;
    MethodChannel backgroundCallbackChannel;
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
      ...
      methodCallHandler = new AlarmManagerPluginMethodCallHandler(binding.getApplicationContext());
      ...
      alarmManagerPluginChannel =
          new MethodChannel(
              ...
              "plugins.flutter.io/android_alarm_manager",
              JSONMethodCodec.INSTANCE);
      alarmManagerPluginChannel.setMethodCallHandler(methodCallHandler);
      ...
      backgroundCallbackChannel =
          new MethodChannel(
              ...
              "plugins.flutter.io/android_alarm_manager_background",
              JSONMethodCodec.INSTANCE);
      backgroundCallbackChannel.setMethodCallHandler(methodCallHandler);
    }
  ...
  private static class AlarmManagerPluginMethodCallHandler implements MethodCallHandler {
    private final Context context;

    AlarmManagerPluginMethodCallHandler(@NonNull Context context) {
    ...
    public void onMethodCall(MethodCall call, Result result) {
      String method = call.method;
      Object arguments = call.arguments;
      Log.d(TAG, "AndroidAlarmManagerPlugin call handler: " + method);
      try {
        if (method.equals("AlarmService.start")) {
          // This message is sent when the Dart side of this plugin is told to initialize.
          long callbackHandle = ((JSONArray) arguments).getLong(0);
